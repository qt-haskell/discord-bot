...
class RoboLiaContext(commands.Context["RoboLia"]):
    ...
    @property
    def reference(self) -> Union[discord.Message, Literal[False], None]:
        message: Any | None = getattr(self.message, "reference", None)
        return isinstance(message, discord.Message) and message or None

    @property
    def referenced_user(self) -> Union[discord.Member, discord.User, Literal[False]]:
    ...
    async def send_help(self, command: Optional[Union[commands.Command, str]] = None) -> None:
